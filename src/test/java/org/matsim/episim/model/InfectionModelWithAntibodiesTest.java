	...
	public void roesslerEtAl(){
...

		{
			...
			double nAbBase;
			{
				...
				nAbBase = relativeAbLevel( ak50PerStrain, basePerson, VirusStrain.SARS_CoV_2 );
			}
			...
			person.checkInfection();
			{
				...
				double nAb = relativeAbLevel( ak50PerStrain, person, strain );
...
//			}
	...
	private double relativeAbLevel( Map<VirusStrain, Double> ak50PerStrain, EpisimPerson basePerson, VirusStrain sars_coV_2 ){
		return InfectionModelWithAntibodies.getAntibodyLevel( basePerson, 100, basePerson.getNumVaccinations(), basePerson.getNumInfections(),
				sars_coV_2 )
