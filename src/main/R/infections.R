...
# 2022-02-20:
base <- "output/seed_4711-ba1Date_2021-11-25-ba1Inf_2.8-ba2Date_2021-12-25-ba2Inf_1.3-oHos_0.3-xMasModel_no-leis_0.75-testing_current/"

base <- "output/seed_4711-ba1Date_2021-11-25-ba1Inf_2.8-ba2Date_2021-12-25-ba2Inf_1.3-oHos_0.3-xMasModel_no-leis_0.75-testing_current-campaignStartDate_2050-09-01-campaignDuration_30.0-campaignVacType_omicronUpdate/"
base <- "output/seed_4711-ba1Date_2021-11-25-ba1Inf_2.8-ba2Date_2021-12-25-ba2Inf_1.3-oHos_0.3-xMasModel_no-leis_0.75-testing_current-campaignStartDate_2022-09-01-campaignDuration_30.0-campaignVacType_omicronUpdate/"
...
p1 <- ggplot() + scale_y_log10(limits = c(50,12000)) +
  ...
  scale_x_date( date_breaks = '1 month', limits = as.Date(c('2021-07-01','2023-06-01')), expand = expansion() ) +
