...
episim_all_runs_raw <- read_and_process_episim_events_BATCH("2021-08-22-auto/","FacilityToDistrictMapCOMPLETE.txt")
...
episim_all_runs <- episim_all_runs_raw %>%
  ungroup() %>%
  pivot_wider(names_from = "automaticallyRestrictDistricts",values_from = "infections")
...
color_scheme <- c("magenta", "dark grey", "dark grey" ,"blue") #,
