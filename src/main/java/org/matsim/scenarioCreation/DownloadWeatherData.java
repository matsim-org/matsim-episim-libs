...
public class DownloadWeatherData implements Callable<Integer> {
	...
	@Parameters(paramLabel = "STATION", arity = "1", description = "Meteostat station id.", defaultValue = "10384") // Berlin: 10384 (tempelholf
	...
	@Option(names = "--output", description = "Output file", defaultValue = "berlinWeather.csv") //todo
	private Path output;
