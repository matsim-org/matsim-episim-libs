...
public class DownloadWeatherDataMunich implements Callable<Integer> {
	...
	// für munich
	@Parameters(paramLabel = "STATION", arity = "1", description = "Meteostat station id.", defaultValue = "10865")
	...
	@Option(names = "--output", description = "Output file", defaultValue = "munichWeather.csv")
	private Path output;
