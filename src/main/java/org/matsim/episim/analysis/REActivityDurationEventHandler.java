...
/**EventHanlder calculating the number of persons for one activityType and the average duration of each person in each type
 * 
 * @author rewert
 */
...
public class REActivityDurationEventHandler implements ActivityStartEventHandler, ActivityEndEventHandler {
	...
	//counts the persons in each acticityType and safes the time of the startActivity
	@Override
	...
	/* -calculates the duration of one activity
	 * - if one person has one activity more then one time a day, it calculates the sum of the different times
	 */
	@Override
