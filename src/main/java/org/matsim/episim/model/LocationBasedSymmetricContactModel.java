 ...
 */
public final class LocationBasedSymmetricContactModel extends LocationBasedAbstractContactModel {
	...
	@Inject
		/* package */
	LocationBasedSymmetricContactModel(SplittableRandom rnd, Config config, TracingConfigGroup tracingConfig,
