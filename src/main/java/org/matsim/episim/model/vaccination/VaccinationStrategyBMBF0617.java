 ...
 */
public class VaccinationStrategyBMBF0617 implements VaccinationModel {
...
//				Collections.shuffle(candidates, new Random(EpisimUtils.getSeed(rnd)));
	...
	public static class Config {
		...
		public Config(LocalDate start, int campaignDuration, VaccinationType vaccinationType,Int2DoubleMap complianceByAge) {
			this.start = start;
