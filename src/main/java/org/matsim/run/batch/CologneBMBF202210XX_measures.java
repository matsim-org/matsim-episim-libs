 ...
 * Batch for Bmbf runs
 */
public class CologneBMBF202210XX_measures implements BatchRun<CologneBMBF202210XX_measures.Params> {
...
//					String StrainA = "6.0";
				...
				if (params != null) {
					...
					antibodyConfig.setUseImmuneResponseForMultiplier(Boolean.parseBoolean("false"));
				}
...
//		episimConfig.setSnapshotPrefix(String.valueOf(params.seed));
		episimConfig.setStartFromSnapshot("/scratch/projects/bzz0020/episim-input/snapshots-cologne-2022-10-14/" + params.seed + "-2022-09-11");
...
//		}
	...
	public static final class Params {
		...
		//IFSG
		@StringParameter({"base","45", "90"})
		public String ifsg;

		// Vacciantion Campaign
		@StringParameter({"base", "ifsg90", "ifsg180", "emergency90", "emergency180"})
		String vacCamp;
		...
		// leisure Public
		@StringParameter({"base","pubPriv50", "pub50"})
		public String leis;

		//edu
		@StringParameter({"base", "half&mask", "mask"})
		public String edu;
	...
	public static void main(String[] args) {
		String[] args2 = {
				RunParallel.OPTION_SETUP, CologneBMBF202210XX_measures.class.getName(),
