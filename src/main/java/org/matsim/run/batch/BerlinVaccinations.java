...
//		episimConfig.setSnapshotSeed(EpisimConfigGroup.SnapshotSeed.reseed);
		...
		vaccinationConfigGroup.getParams(VaccinationType.generic).setEffectiveness(params.effectiveness);
		vaccinationConfigGroup.getParams(VaccinationType.generic).setDaysBeforeFullEffect(params.daysBeforeFullEffect);
