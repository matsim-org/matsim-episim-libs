...
public class CologneCalibration implements BatchRun<CologneCalibration.Params> {
	...
	public Config prepareConfig(int id, Params params) {
		...
		episimConfig.setCalibrationParameter(episimConfig.getCalibrationParameter() * 0.96 * 1.06 * params.tf);
...
;
	...
	public static final class Params {
		...
		@StringParameter({"2021-12-22", "2021-12-24", "2021-12-26", "2021-12-28", "2021-12-30"})
		String ba2Date;
