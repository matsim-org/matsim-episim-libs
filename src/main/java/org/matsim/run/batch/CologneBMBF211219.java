...
//		}
		...
		virusStrainConfigGroup.getOrAddParams(VirusStrain.DELTA).setFactorSeriouslySickVaccinated(2.0);
		...
		virusStrainConfigGroup.getOrAddParams(VirusStrain.OMICRON_BA1).setInfectiousness(deltaInf * 3.0);
		virusStrainConfigGroup.getOrAddParams(VirusStrain.OMICRON_BA1).setFactorSeriouslySick(params.oHosF);
		virusStrainConfigGroup.getOrAddParams(VirusStrain.OMICRON_BA1).setFactorSeriouslySickVaccinated(params.oHosF);
...
private void adaptVacinationEffectiveness2(VaccinationConfigGroup vaccinationConfig, double vacMult) {
		...
		VaccinationConfigGroup.Parameter parameterAlphaMRNA = VaccinationConfigGroup.forStrain(VirusStrain.ALPHA);
		{
		...
		VaccinationConfigGroup.Parameter parameterDeltaMRNA = VaccinationConfigGroup.forStrain(VirusStrain.DELTA);
		{
		...
		VaccinationConfigGroup.Parameter parameterOmicronMRNA = VaccinationConfigGroup.forStrain(VirusStrain.OMICRON_BA1);
		{
		...
		VaccinationConfigGroup.Parameter parameterAlphaMRNAInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.ALPHA);
		{
		...
		VaccinationConfigGroup.Parameter parameterDeltaMRNAInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.DELTA);
		{
		...
		VaccinationConfigGroup.Parameter parameterOmicronMRNAInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.OMICRON_BA1);
		{
		...
		VaccinationConfigGroup.Parameter parameterAlphaVector = VaccinationConfigGroup.forStrain(VirusStrain.ALPHA);
		{
		...
		VaccinationConfigGroup.Parameter parameterDeltaVector = VaccinationConfigGroup.forStrain(VirusStrain.DELTA);
		{
		...
		VaccinationConfigGroup.Parameter parameterOmicronVector = VaccinationConfigGroup.forStrain(VirusStrain.OMICRON_BA1);
		{
		...
		VaccinationConfigGroup.Parameter parameterAlphaVectorInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.ALPHA);
		{
		...
		VaccinationConfigGroup.Parameter parameterDeltaVectorInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.DELTA);
		{
		...
		VaccinationConfigGroup.Parameter parameterOmicronVectorInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.OMICRON_BA1);
		{
	...
	private void configureBooster(VaccinationConfigGroup vaccinationConfig, double boosterEff, double boosterSpeed, int boostAfter, double vacMult, LocalDate restrictionDate, double omicronBoost, double vacSp) {
		...
		VaccinationConfigGroup.Parameter parameterAlpha = VaccinationConfigGroup.forStrain(VirusStrain.ALPHA);
		VaccinationConfigGroup.Parameter parameterDelta = VaccinationConfigGroup.forStrain(VirusStrain.DELTA);
		VaccinationConfigGroup.Parameter parameterOmicron = VaccinationConfigGroup.forStrain(VirusStrain.OMICRON_BA1);
		...
		VaccinationConfigGroup.Parameter parameterAlphaInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.ALPHA);
		VaccinationConfigGroup.Parameter parameterDeltaInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.DELTA);
		VaccinationConfigGroup.Parameter parameterOmicronInfectivity = VaccinationConfigGroup.forStrain(VirusStrain.OMICRON_BA1);
