...
public class SnzMunichWeekScenario2020Symmetric extends AbstractSnzScenario2020  {
	/**
	 * Sample size of the scenario (Either 25 or 100)
	 */
	private final int sample;

	public SnzMunichWeekScenario2020Symmetric() {
		this(25);
	}

	public SnzMunichWeekScenario2020Symmetric(int sample) {
		this.sample = sample;
	}
	...
	public Config config() {
		...
		Config config = new SnzMunichScenario25pct2020().config();
